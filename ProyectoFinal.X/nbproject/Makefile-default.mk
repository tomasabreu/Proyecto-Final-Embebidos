...
${OBJECTDIR}/PHONE_MANAGER.o: PHONE_MANAGER.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PHONE_MANAGER.o.d 
	@${RM} ${OBJECTDIR}/PHONE_MANAGER.o 
	@${FIXDEPS} "${OBJECTDIR}/PHONE_MANAGER.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"freeRTOS/include" -I"freeRTOS/portable/MPLAB/PIC32MM" -MMD -MF "${OBJECTDIR}/PHONE_MANAGER.o.d" -o ${OBJECTDIR}/PHONE_MANAGER.o PHONE_MANAGER.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I freeRTOS/include -I freeRTOS/portable/MPLAB/PIC32MM -I .. -mdfp=${DFP_DIR}  
