...
/** 
 * @Function
 *    bool switchID(bool* needNewInput, uint8_t* dataArray)
 *
 * @Summary
...
/** 
 * @Function
 *    bool switchPhoneNumber(bool* needNewInput, uint8_t* dataArray2)
 *
 * @Summary
...
/** 
 * @Function
 *    bool switchChangeLedColor(bool* needNewInput, uint8_t* dataArray)
 *
 * @Summary
